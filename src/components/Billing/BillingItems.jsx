...
import { FaBoxes, FaCode, FaNewspaper, FaPercentage, FaSearch, FaCamera } from 'react-icons/fa';
...
import { InventorySearchModalImagen } from '../Inventory/InventorySearchModalImagen';
...
export const BillingItems = (props) => {
    ...
    const handleSearchArticleImagenBilling = async (e) => {
        dispatch(SetOpenSearchInventoryBilling({ value: true, number: numberScreen }));
        dispatch(CleanDetalleActualBilling({ number: numberScreen }));
        dispatch(startGetProductsImagen(numberScreen))
        dispatch(SetValorFiltroSearchModalInventory(""));
    }
                        ...
                        <div className="col-md-3 mb-3">
                            ...
                            <div className="input-group">
                                ...
                                <button
                                    ...
                                    className={
                                        (billings[numberScreen] !== undefined)
                                            ? (billings[numberScreen].enableItems) ? 'btn btn-success' : 'btn btn-success disabled'
                                            : 'btn btn-primary disabled'
                                    }
                                    onClick={handleSearchArticleImagenBilling}
                                    data-bs-toggle="modal"
                                    data-bs-target="#modalBuscarArticuloImagen"
