...
import { SetId_BodegaInventory } from "../../actions/inventory";
import { AiFillExclamationCircle } from "react-icons/ai";
import { FaSearch } from "react-icons/fa";

export const InventorySearchBodegaTable = ({ columns, data }) => {
  ...
  const handleSelectedRow = async (cell) => {
    const { idBodega } = cell.row.values;
    if (idBodega !== null) {
      dispatch(SetId_BodegaInventory(idBodega));
    }
  };
