...
import { startSetCodPadreInventory } from "../../actions/inventory";

export const InventorySearchCodPadreTable = ({ columns, data }) => {
  ...
  const handleSelectedRow = async (cell) => {
    ...
    //Obtener el codigo seleccionado
    const { codigo } = cell.row.original;

    if (codigo !== null) {
      dispatch( startSetCodPadreInventory( codigo, inventory.codigo ) );
    }
  }
