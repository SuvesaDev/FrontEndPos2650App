...
import { SetCodPresentacionInventory } from "../../actions/inventory";
export const InventorySearchPresentacionTable = ({ columns, data }) => {
  ...
  const handleSelectedRow = async (cell) => {
    ...
    const { codPres } = cell.row.values;
    if (codPres !== null) {
      dispatch(SetCodPresentacionInventory(codPres));
    }
  };
