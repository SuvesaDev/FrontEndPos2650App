...
export const CountsWihoutPaySearchProveedorModalTable = ({ columns, data }) => {
  ...
  const handleSelectedRow = async (cell) => {
    const { codigoProv, cedula, nombre, direccion, plazo, telefonoCont } = cell.row.original;
    console.log(cell.row.original)
    dispatch(SetCodigoProveedorWihoutPay(codigoProv));
    dispatch(SetCedulaProveedorWihoutPay(cedula));
    dispatch(SetNombreProveedorWihoutPay(nombre));
    dispatch(SetDireccionProveedorWihoutPay(direccion));
    dispatch(SetPlazoDiasProveedorWihoutPay(plazo));
    dispatch(SetTelefonoProveedorWihoutPay(telefonoCont));
