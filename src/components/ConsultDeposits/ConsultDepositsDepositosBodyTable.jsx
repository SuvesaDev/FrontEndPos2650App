...
import {
    ...
    startGetOneDepositsConsultDeposits
} from '../../actions/ConsultDepositsAction';
import { FaArrowLeftLong, FaArrowRightLong } from 'react-icons/fa6';

export const ConsultDepositsDepositosBodyTable = ({ columns, data }) => {
    ...
    const handleSelectRow = (cell) => {
        ...
        if (!disableInputs) {
            ...
            dispatch(startGetOneDepositsConsultDeposits(id));
            dispatch(SetIsOpenDepositsModalConsultDeposits(true));
        }
                                        ...
                                        <tr {...row.getRowProps()} >
                                            {row.cells.map(cell => {
                                                return <td {...cell.getCellProps()}
                                                    ...
                                                    data-bs-target="#modalDepositoFiltrado"
                                                >
                                                    {cell.render("Cell")}
                                                </td>
                                            })}
