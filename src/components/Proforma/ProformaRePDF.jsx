...
export const ProformaRePDF = (data) => {
    const datos = data.data
    const { datosSucursal, datosProforma } = datos;
    const {cotizacion1, fechaReporte, codMoneda, detalle, descuento, impVenta, subTotal, subTotalExento, subTotalGravada, total, transporte, idFactura, quienCotiza } = datosProforma;
    ...
    return (
        <PDFViewer style={{ width: '100%', height: '100vh' }}>
            <Document title={`Cotización Nº${cotizacion1}`}>
                        ...
                        <View style={styles.blueBox}>
                            <View style={styles.headerSection}>
                                <View style={styles.headerSubSection}>
                                    <Text>Cotización # {cotizacion1}</Text>
                                </View>
                                <View style={styles.headerSubSection}>
